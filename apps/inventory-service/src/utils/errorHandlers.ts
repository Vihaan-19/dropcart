...
// Basic helper for consistent error responses - can be updated to handle custom errors
export function handleError(res: Response, message: string, err: unknown, code = 500) {
  ...
  // Send a generic error message to the client, potentially adding more details in development
  let statusCode = code;
...
// You might define custom error classes here later, e.g., NotFoundError, UnauthorizedError 